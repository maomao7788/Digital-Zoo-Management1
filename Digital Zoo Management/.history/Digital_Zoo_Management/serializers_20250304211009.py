...
class ZookeeperSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if Zookeeper.objects.filter(user=user).exists():
            raise serializers.ValidationError({"user": "This user is already assigned as a zookeeper."})  
        return Zookeeper.objects.create(**validated_data)

...
from .views import (
    ...
    UserViewSet, MembershipViewSet, SpecialEventViewSet, EventRegistrationViewSet, FeedbackViewSet,get_current_user,
...
urlpatterns = [
    ...
    path('admin/events/<int:event_id>/registrations/', AdminEventRegistrationsView.as_view(), name='admin_event_registrations'),
]

...
from .views import (register_user,
                    ...
                    ActivityLogViewSet, UserViewSet,UserViewSet, send_task_email,complete_task,  get_user_tasks,ApplyMembershipView, MembershipListView, MembershipUpdateView
                    )
...
urlpatterns = [
    ...
    path('apply-membership/', ApplyMembershipView.as_view(), name='apply-membership'),

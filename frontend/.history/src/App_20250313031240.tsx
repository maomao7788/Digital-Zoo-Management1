...
//           <Link component={RouterLink} to="/membership-admin" color="inherit" underline="none" sx={{ mr: 2 }}>Membership Admin</Link>
//           <Box sx={{ flexGrow: 1 }}></Box>
...
//         <Route path="/membership-admin" element={<PrivateRoute><MembershipAdmin /></PrivateRoute>} />
//       </Routes>
//     </Router>
//   );
// }
...
import EventManagement from './pages/ManageEventsPage';
import PrivateRoute from './components/PrivateRoute';
import { AppBar, Toolbar, Link, Button, Box } from '@mui/material';
import { logout } from './services/authApi';
import { Link as RouterLink } from 'react-router-dom';
    ...
    <Router>
      <AppBar position="static">
        <Toolbar>
          ...
          <Link component={RouterLink} to="/apply-membership" color="inherit" underline="none" sx={{ mr: 2 }}>Apply Membership</Link>
          <Link component={RouterLink} to="/membership-admin" color="inherit" underline="none" sx={{ mr: 2 }}>Membership Admin</Link>
          <Link component={RouterLink} to="/events" color="inherit" underline="none" sx={{ mr: 2 }}>Events</Link>
          <Link component={RouterLink} to="/manage-events" color="inherit" underline="none" sx={{ mr: 2 }}>Manage Events</Link>
          <Box sx={{ flexGrow: 1 }}></Box>
          <Button color="inherit" onClick={handleLogout}>Logout</Button>
        </Toolbar>
      </AppBar>
      ...
      <Routes>
        ...
        <Route path="/manage-events" element={<PrivateRoute><EventManagement /></PrivateRoute>} />
        <Route path="/" element={<PrivateRoute><AnimalList /></PrivateRoute>} />
        <Route path="/create" element={<PrivateRoute><CreateAnimal /></PrivateRoute>} />
        <Route path="/edit/:id" element={<PrivateRoute><EditAnimal /></PrivateRoute>} />
        <Route path="/habitats" element={<PrivateRoute><HabitatList /></PrivateRoute>} />

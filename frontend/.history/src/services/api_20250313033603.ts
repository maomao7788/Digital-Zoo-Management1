...
export const applyEventRegistration = (data: { event: number }) => api.post('registrations/', data);
export const updateEventRegistrationStatus = (id: number, status: string) =>api.post(`registrations/${id}/update_status/`, { status });
...
export const getEventRegistrations = () => api.get('event-registrations/');

...
const ZookeeperPage: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <Button  onClick={handleCreateZookeeper} style={{ marginLeft: 10 }}>
          Create Zookeeper
        </Button>
      </div>
  ...
  {zookeepers.map(zookeeper => (
    <TableRow key={zookeeper.id}>
      <TableCell>{zookeeper.user_info?.username || "Unknown"}</TableCell>  
      <TableCell>{zookeeper.user_info?.email || "Unknown"}</TableCell>  
      ...
      <TableCell>
        ...
        <Button  onClick={() => handleDeleteZookeeper(zookeeper.id!)} style={{ marginLeft: 10 }}>Delete</Button>
      </TableCell>
    </TableRow>
  ))}
</TableBody>

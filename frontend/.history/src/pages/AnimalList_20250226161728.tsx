...
const AnimalList = () => {
  ...
  const getHabitatName = (habitat_name?: Habitat | null) => {
    return habitat_name ? habitat_name.name : 'Unassigned';
  };
...
//   habitat_name: Habitat | null; // 用于显示栖息地名称
// }
...
//                 <TableCell>{animal.lifespan}</TableCell>
//                 <TableCell>{animal.behaviour}</TableCell>
//                 <TableCell>{animal.habitat_name?.name || 'Unassigned'}</TableCell>
//                 <TableCell>
//                   <Button color="primary" onClick={() => navigate(`/edit/${animal.id}`)}>Edit</Button>
//                   <Button color="secondary" onClick={() => removeAnimal(animal.id)}>Delete</Button>
//                 </TableCell>

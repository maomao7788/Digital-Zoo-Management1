          ...
          <TableBody>
            {careRoutines.map((routine) => (
              <TableRow key={routine.id}>
                ...
                <TableCell>
                  <Button  onClick={() => handleDeleteCareRoutine(routine.id!)}>Delete</Button></TableCell>
                  <TableCell><Button variant="contained" color="primary" onClick={() => handleSendEmail(routine.id!)}>Send Email</Button></TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>

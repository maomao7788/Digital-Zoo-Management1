          ...
          <TableBody>
            {careRoutines.map((routine) => (
              <TableRow key={routine.id}>
                ...
                <TableCell>
                  <Button onClick={() => handleSendEmail(routine.id)} style={{ marginRight: 10 }} variant="contained" color="primary">
                    Send Email
                  </Button>
                  <Button onClick={() => handleDeleteCareRoutine(routine.id)} variant="contained" color="secondary">
                    Delete
                  </Button>
                </TableCell>
              </TableRow>

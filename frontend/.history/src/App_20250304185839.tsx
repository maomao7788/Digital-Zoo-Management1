    ...
    <Router>
      <AppBar position="static">
        <Toolbar>
          ...
          <Link component={RouterLink} to="/zookeepers">Zookeepers</Link>
          <Link component={RouterLink} to="/care-routines">Care Routines</Link>
          <Link component={RouterLink} to="/activity-logs">Activity Logs</Link>
